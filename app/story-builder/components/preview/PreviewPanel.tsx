...
export function PreviewPanel() {
  ...
  const { enabled } = useMultiDeviceStore();
  ...
  return (
    <div className="flex flex-col h-full bg-background border rounded-2xl overflow-hidden shadow-sm">
      <div className="p-3 border-b bg-background/50 backdrop-blur-md flex items-center justify-between gap-3">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        {enabled ? (
          <DeviceMatrix
            previewUrl="/story-preview"
            className="w-full h-full overflow-auto"
          />
        ) : (
          /* Single Device View */
          <div className="flex items-center justify-center p-6 bg-linear-to-b from-muted/50 to-muted/20 h-full">
            {isLoading && (
