/**
 * T019: [US2] Unit test for ConfigPanel overlay behavior
 * 
 * Tests that ConfigPanel:
 * - Converts to Radix UI Dialog overlay
 * - Has fixed positioning with centered layout
 * - Has proper width constraints (400px max 90vw)
 * - Has z-index management (z-50 panel, z-40 backdrop)
 * - Has fade + scale animations
 * - Has close button (X)
 * - Dialog.Root is properly controlled by panel.visible state
 */
...
describe('ConfigPanel - Overlay Behavior (US2)', () => {
  beforeEach(() => {
  ...
  describe('State management', () => {
    it('should respect panelState.visible from useUIStore', () => {
      ...
      // Dialog should not render when visible is false
