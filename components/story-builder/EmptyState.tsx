...
export function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-muted/5 rounded-3xl border-2 border-dashed border-muted-foreground/10 m-4">
      <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-purple-500/20 via-pink-500/20 to-orange-500/20 flex items-center justify-center mb-6">
      ...
      <Button 
        ...
        className="rounded-full px-8 bg-gradient-to-r from-purple-600 to-pink-600 hover:opacity-90 transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
      >
