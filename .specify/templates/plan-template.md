...
**Note**: This template is filled in by the `/zo.plan` command. See `.specify/templates/commands/plan.md` for the execution workflow.
...
└── tasks.md             # Phase 2 output (/zo.tasks command - NOT created by /zo.plan)
```
